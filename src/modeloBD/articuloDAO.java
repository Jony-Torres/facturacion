   ...
   public List<articulo> listdeartic_sucursal(String sucr){
        ...
        try {
            PreparedStatement conex = con.conectar_bd().prepareStatement("SELECT exi.cod_sucursal,exi.desc_sucursal,exi.cod_deposito,exi.desc_deposito,exi.cod_articulo,exi.cod_un_medida,exi.nro_lote,exi.desc_articulo,exi.existencia "
                                                                        ...
                                                                        + "where  exi.cod_sucursal = '"+sucr+"' ORDER BY 1,3,5");
    ...
    public List<articulo> listdeartic_deposito(String sucr,String dep){
        ...
        try {
            PreparedStatement conex = con.conectar_bd().prepareStatement("SELECT exi.cod_sucursal,exi.desc_sucursal,exi.cod_deposito,exi.desc_deposito,exi.cod_articulo,exi.cod_un_medida,exi.nro_lote,exi.desc_articulo,exi.existencia "
                                                                        + "FROM view_existencia_articulo exi "
                                                                        + "where  exi.cod_sucursal = '"+sucr+"' and exi.cod_deposito = '"+dep+"' ORDER BY 1,3,5");
            ResultSet result = conex.executeQuery();
            while(result.next()){
                exis = new articulo();
                exis.setCod_sucursal(result.getString(1));
    ...
    public List<articulo> listdearticulo_LOV(String suc,String dep){
        ...
        try {
            PreparedStatement conex = con.conectar_bd().prepareStatement("SELECT exi.cod_sucursal,exi.desc_sucursal,exi.cod_deposito,exi.desc_deposito,exi.cod_articulo,exi.cod_un_medida,exi.nro_lote,exi.desc_articulo,exi.existencia "
                                                                        + "FROM view_existencia_articulo exi "
                                                                        + "where  exi.cod_sucursal = '"+suc+"' and exi.cod_deposito = '"+dep+"' ORDER BY 1,3,5");
            ResultSet result = conex.executeQuery();
            while(result.next()){
                exis = new articulo();
                exis.setCod_articulo(result.getString(5));
    ...
    public Integer retorna_cant_cod_aticulo(String suc,String artc,String dep){
       Integer cant =  null;
        try {
            ...
            con.ps = con.conectar_bd().prepareStatement("SELECT COUNT(v.cod_articulo) cantidad FROM view_existencia_articulo v WHERE v.cod_sucursal = '"+suc+"' and v.cod_deposito = '"+dep+"' and v.cod_articulo = '"+artc+"'");
            con.rs=con.ps.executeQuery();
            con.rs.next();
    ...
    public Integer retorna_cant_cod_aticulo_ajust(String artc){
       Integer cant =  null;
        try {
            //con.ps = con.conectar_bd().prepareStatement("SELECT COUNT(v.cod_articulo) cantidad FROM view_existencia_articulo v WHERE v.cod_articulo = '"+artc+"'");
            con.ps = con.conectar_bd().prepareStatement("SELECT COUNT(v.cod_articulo) cantidad FROM articulo v WHERE v.cod_articulo = '"+artc+"'");
            con.rs=con.ps.executeQuery();
            con.rs.next();
            cant=con.rs.getInt("cantidad");
            //con.closeConnection();
   ...
   public String retorna_desc_articulo(String suc,String artc,String dep,String unid,String lot){
       String desc =  null;
        try {
            ...
            con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo FROM articulo v WHERE v.cod_articulo = '"+artc+"' AND v.cod_un_medida = '"+unid+"' AND v.nro_lote = '"+lot+"' ");
            con.rs=con.ps.executeQuery();
            con.rs.next();
            desc=con.rs.getString("desc_articulo");
            //con.closeConnection();
   ...
   public int retorna_precioun_art(String artc,String und,String lot){
    ...
    public ArrayList<articulo> dato_articulo(String articulo){
        ...
        try {
            ...
            //con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo,v.cod_un_med,v.nro_lote FROM articulo v WHERE v.cod_articulo = '"+articulo+"'");
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                art = new articulo();
    ...
    public ArrayList<articulo> dato_articulo_ajust(String articulo){
        ArrayList listaart= new ArrayList();
        articulo art;
        try {
            //con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo,v.cod_un_medida,v.nro_lote FROM view_existencia_articulo v WHERE v.cod_articulo = '"+articulo+"'");
    ...
    public ArrayList<articulo> dato_art_un_lot(String articulo,String und,String lot){
        ArrayList listaart= new ArrayList();
        articulo art;
        try {
            //con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo,v.cod_un_medida,v.nro_lote FROM view_existencia_articulo v WHERE v.cod_articulo = '"+articulo+"'");
            con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo,v.cod_un_medida,v.nro_lote FROM view_existencia_articulo v WHERE v.cod_articulo = '"+articulo+"' AND v.cod_un_medida = '"+und+"' AND v.nro_lote = '"+lot+"'");
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                art = new articulo();
                art.setDesc_articulo(con.rs.getString(1));
    ...
    public ArrayList<articulo> dato_art_un_lot_ajust(String articulo,String und,String lot){
        ArrayList listaart= new ArrayList();
        articulo art;
        try {
            //con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo,v.cod_un_medida,v.nro_lote FROM view_existencia_articulo v WHERE v.cod_articulo = '"+articulo+"'");
            con.ps = con.conectar_bd().prepareStatement("SELECT v.desc_articulo,v.cod_un_med,v.nro_lote FROM articulo v WHERE v.cod_articulo = '"+articulo+"' AND v.cod_un_med = '"+und+"' AND v.nro_lote = '"+lot+"'");
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                art = new articulo();
                art.setDesc_articulo(con.rs.getString(1));
