...
public class factura_ventaDAO {
    ...
    public String insertcomprobante_venta(factura_venta fact){
        ...
        try {
            ...
            con.ps.setDouble(19,fact.getTotal_descuento());
    ...
    public String insertcomprobante_venta_detalle(factura_venta fact){
        ...
        try {
            ...
            //con.ps.setInt(9,0);
            con.ps.setDouble(9,fact.getDescuento());
       ...
       ArrayList listacomprobante= new ArrayList();
        ...
        try {
            ...
            while(con.rs.next()){
                 ...
                 fact.setDescuento(con.rs.getDouble(40));
                 fact.setTotal_descuento(con.rs.getDouble(41));
