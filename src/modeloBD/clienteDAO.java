...
public class clienteDAO {
    ...
    public String insertcliente(cliente cli){
        ...
        try {
            ...
            con.ps.setString(10,cli.getCod_sucursal());
    ...
    public List<cliente> listcliente(String valor){
        List<cliente> listacliente = new ArrayList<>();
        cliente clie;
        try {
            PreparedStatement conex = con.conectar_bd().prepareStatement("SELECT v.cod_cliente,v.nombre,v.cobrador,v.vendedor,v.condicion,v.tipo_cliente,v.estado FROM view_cliente v WHERE v.cod_sucursal = '"+valor+"'");
    ...
    public List<cliente> listcliente_LOV(String valor){
        List<cliente> listacliente = new ArrayList<>();
        cliente clie;
        try {
            PreparedStatement conex = con.conectar_bd().prepareStatement("SELECT c.cod_cliente,p.nombre FROM cliente c LEFT JOIN persona p ON (c.cod_persona = p.cod_persona) WHERE c.estado = 'A' and c.cod_sucursal = '"+valor+"'");
            ResultSet result = conex.executeQuery();
            while(result.next()){
                 clie= new cliente();
                 clie.setCod_cliente(result.getInt(1));
    ...
    public List<cliente> listclientenrodoc_LOV(String valor,String sucur){
        List<cliente> listacliente = new ArrayList<>();
        cliente clie;
        try {
            PreparedStatement conex = con.conectar_bd().prepareStatement("SELECT c.cod_cliente,p.nombre FROM cliente c LEFT JOIN persona p ON (c.cod_persona = p.cod_persona) where p.ruc_ci = '"+valor+"' and c.estado = 'A' and c.cod_sucursal = '"+sucur+"'");
            ResultSet result = conex.executeQuery();
            while(result.next()){
                 clie= new cliente();
                 clie.setCod_cliente(result.getInt(1));
    ...
    public List<cliente> listclientenomb_LOV(String valor,String sucur){
        List<cliente> listacliente = new ArrayList<>();
        cliente clie;
        try {
            con.ps = con.conectar_bd().prepareStatement("SELECT c.cod_cliente,p.nombre FROM cliente c LEFT JOIN persona p ON (c.cod_persona = p.cod_persona) where p.nombre like '"+valor+"' and c.estado = 'A' and c.cod_sucursal = '"+sucur+"'");
    ...
    public ArrayList<cliente> listclientedesc(String nom,String sucur){
        ArrayList listaclientedesc= new ArrayList();
        cliente clie;
        try {
            con.ps = con.conectar_bd().prepareStatement("SELECT v.cod_cliente,v.nombre,v.cobrador,v.vendedor,v.condicion,v.tipo_cliente,v.estado FROM view_cliente v WHERE v.nombre LIKE '"+nom+"' and v.cod_sucursal = '"+sucur+"'");
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                 clie= new cliente();
                 clie.setCod_cliente(con.rs.getInt(1));
    ...
    public ArrayList<cliente> listclientenrodoc(String nom,String sucur){
        ArrayList listaclientedesc= new ArrayList();
        cliente clie;
        try {
            con.ps = con.conectar_bd().prepareStatement("SELECT v.cod_cliente,v.nombre,v.cobrador,v.vendedor,v.condicion,v.tipo_cliente,v.estado FROM view_cliente v WHERE v.cod_persona='"+nom+"' and v.cod_sucursal = '"+sucur+"'"); 
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                 clie= new cliente();
                 clie.setCod_cliente(con.rs.getInt(1));
    ...
    public ArrayList<cliente> listclientcod(String cod,String sucur){
        ArrayList listaclientedesc= new ArrayList();
        cliente clie;
        try {
            con.ps = con.conectar_bd().prepareStatement("SELECT * FROM view_cliente n WHERE n.cod_cliente='"+cod+"' and n.cod_sucursal = '"+sucur+"'"); 
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                 clie= new cliente();
                 clie.setCod_cliente(con.rs.getInt(1));
    ...
    public ArrayList<cliente> listaclientedit(String valor,String sucur){
        ArrayList listacliente= new ArrayList();
        cliente per;
        try {
            con.ps = con.conectar_bd().prepareStatement("SELECT * FROM view_cliente WHERE cod_cliente='"+valor+"' and cod_sucursal = '"+sucur+"'");
            con.rs=con.ps.executeQuery();
            while(con.rs.next()){
                 per= new cliente();
