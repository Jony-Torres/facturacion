    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()== vistaMenuprinc.Formperson){
           FORMPERSON vistap=new FORMPERSON();
            ...
            controlador_persona ctrlper=new controlador_persona(vistap, per,grupo,"CC","FORMPERSON",suc);
        ...
        if(e.getSource()== vistaMenuprinc.FORMCLIENT){
           FORMCLIENT vistcl=new FORMCLIENT();
            ...
            controlador_cliente ctrlcl=new controlador_cliente(vistcl,cli,grupo,"CC","FORMCLIENT",suc);
        ...
        if(e.getSource()== vistaMenuprinc.FORMCOSACL){
           FORMCOSACL vistsald=new FORMCOSACL();
            ...
            controlador_cons_saldo_cliente ctrlsal=new controlador_cons_saldo_cliente(vistsald,cons,suc);
        ...
        if(e.getSource()== vistaMenuprinc.FORMPROVEE){
           FORMPROVEE vistprov=new FORMPROVEE();
            ...
            controlador_proveedor ctrlprov=new controlador_proveedor(vistprov,prove,grupo,"CP","FORMPROVEE",suc);
        ...
        if(e.getSource()== vistaMenuprinc.REPEXTCLI1){
           REPEXTCLI1 visthab=new REPEXTCLI1();
            controlador_extract_cuent_client ctrlextclient=new controlador_extract_cuent_client(visthab,suc);
            visthab.setVisible(true); 
        }
