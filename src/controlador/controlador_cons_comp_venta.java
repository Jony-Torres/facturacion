...
public class controlador_cons_comp_venta extends FORMCNCMVE implements ActionListener,KeyListener,MouseListener{
    ...
    public controlador_cons_comp_venta(FORMCNCMVE vistaCons_comp_venta,cons_comp_ventaDAO modeloCons_comp_venta,String suc) {
        ...
        this.vistaCons_comp_venta.btn_imprimir.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vistaCons_comp_venta.btn_imprimir) {
            int bselect = vistaCons_comp_venta.tbl_comp_venta.getSelectedRow();
            if (bselect == -1) {
                JOptionPane.showMessageDialog(null, "Para poder realizar la operacion, debe seleccionar un registro en el detalle  ", "Mensaje Del Sistema", JOptionPane.WARNING_MESSAGE);
            }else {
                int opc = JOptionPane.showConfirmDialog(null,"Desea Imprimir el comprobante Seleccionado?", "Mensaje Del Sistema", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                if (opc == JOptionPane.YES_OPTION) {
                    ...
                    ctrlfact.imprimir_comprobante(vistaCons_comp_venta.tbl_comp_venta.getValueAt(bselect, 2).toString(),
                                                  vistaCons_comp_venta.tbl_comp_venta.getValueAt(bselect, 3).toString(),
                                                  Integer.parseInt(vistaCons_comp_venta.tbl_comp_venta.getValueAt(bselect, 4).toString()),
                                                  vistaCons_comp_venta.tbl_comp_venta.getValueAt(bselect, 0).toString());
                }
            }
        }
    }
