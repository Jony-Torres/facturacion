...
public class controlador_rep_recib_em1 extends REPRECEMI1 implements ActionListener,KeyListener {
    ...
    public controlador_rep_recib_em1(REPRECEMI1 vistaRep_rec_em1,String suc) {
        ...
        this.vistaRep_rec_em1.txt_cod_cobrador.addActionListener(this);
        this.vistaRep_rec_em1.txt_cod_cobrador.addKeyListener(this);
        this.vistaRep_rec_em1.tbl_busq_cliente.addKeyListener(this);
        this.vistaRep_rec_em1.tbl_bcobrador.addKeyListener(this);
        ...
        this.vistaRep_rec_em1.btn_cobrador.addActionListener(this);
        this.vistaRep_rec_em1.btn_agregar.addActionListener(this);
        this.vistaRep_rec_em1.btn_agreg_suc.addActionListener(this);
        this.vistaRep_rec_em1.btn_agreg_cob.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()== vistaRep_rec_em1.txt_cod_cliente){
            if (vistaRep_rec_em1.txt_cod_cliente.getText().equals("")) {
                ...
                vistaRep_rec_em1.txt_cod_cobrador.requestFocus();
            }else{
        ...
        if(e.getSource()== vistaRep_rec_em1.txt_cod_cobrador){
            if (vistaRep_rec_em1.txt_cod_cobrador.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Campo Obligatorio", "Abvertencia", JOptionPane.WARNING_MESSAGE);
                vistaRep_rec_em1.txt_cod_cobrador.requestFocus();
            }else{
                String res = modeloCobrador.retorna_desc_cobrador(vistaRep_rec_em1.txt_cod_cobrador.getText());
                if(res!= null){
                    vistaRep_rec_em1.txt_desc_cobrador.setText(res);
                    vistaRep_rec_em1.txt_fecha_rec_desde.requestFocus();
                }else {
                    vistaRep_rec_em1.txt_cod_cobrador.setText("");
                    vistaRep_rec_em1.txt_desc_cobrador.setText("");
                }
            }
        }
        ...
        if (e.getSource()== vistaRep_rec_em1.btn_cobrador){
            vistaRep_rec_em1.ventana_cobrador();
            cargar_busqueda_cobrador(vistaRep_rec_em1.tbl_bcobrador);
        }
        if (e.getSource() == vistaRep_rec_em1.btn_agreg_cob) {
            agregar_cobrador();
        }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getSource()== vistaRep_rec_em1.tbl_bcobrador){
                if (e.VK_ENTER==e.getKeyCode()){
                    agregar_cobrador();
                }
        }
    ...
    private void imprimir_recibos_emitidos() {
        ...
        try {
                try {
                    ...
                    //
                    if (vistaRep_rec_em1.txt_cod_cobrador.getText().equals("")) {
                        parametros.put("P_COD_COBRADOR",null);
                    } else {
                        parametros.put("P_COD_COBRADOR",vistaRep_rec_em1.txt_cod_cobrador.getText());
                    }
                    //
    ...
    private void cargar_busqueda_cliente(JTable tbl_busq_cliente, String opc) {
        ...
        if(opc == "DOC") {
            List<cliente> clienteList = modeloCliente.listclientenrodoc_LOV(vistaRep_rec_em1.txt_ci_ruc.getText(),sucursal);
            for (cliente rpc : clienteList) {
                columna[0] =rpc.getCod_cliente();
                columna[1] =rpc.getDesc_persona();
                model.addRow(columna);
        ...
        if(opc == "NOMBRE") {
            List<cliente> clienteList = modeloCliente.listclientenomb_LOV(vistaRep_rec_em1.txt_nomb_cliente.getText(),sucursal);
            for (cliente rpc : clienteList) {
                columna[0] =rpc.getCod_cliente();
                columna[1] =rpc.getDesc_persona();
                model.addRow(columna);
    ...
    private void cargar_busqueda_cobrador(JTable tbl_bcobrador) {
        DefaultTableModel model =new DefaultTableModel();
    ...
    private void agregar_cobrador() {
        int cod =vistaRep_rec_em1.tbl_bcobrador.getSelectedRow();
            if (cod==-1) {
                JOptionPane.showMessageDialog(null, "Debe Seleccionar Una Fila Para Poder Realizar La Operacion  ", "Mensaje Del Sistema", JOptionPane.WARNING_MESSAGE);
            } else {
                this.vistaRep_rec_em1.txt_cod_cobrador.setText(vistaRep_rec_em1.tbl_bcobrador.getValueAt(cod, 0).toString());
                this.vistaRep_rec_em1.txt_desc_cobrador.setText(vistaRep_rec_em1.tbl_bcobrador.getValueAt(cod, 1).toString());
                this.vistaRep_rec_em1.cerrar_ventana_cobrador();
                vistaRep_rec_em1.txt_cod_cobrador.requestFocus();
            }
    }
}
