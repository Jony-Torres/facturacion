...
public class controlador_ajuste_stock extends FORMAJUSTK implements ActionListener,KeyListener,FocusListener  {
    ...
    public controlador_ajuste_stock(FORMAJUSTK vistaAjusStock,ajuste_stockDAO modeloAjusStock) {
        ...
        this.vistaAjusStock.tbl_art_un_lote.addKeyListener(this);
        ...
        this.vistaAjusStock.btn_agreg_art2.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()== vistaAjusStock.btn_agreg_art2){
            agregar_lote_art();
        }
        //
        ...
        if(e.getSource()== vistaAjusStock.txt_cod_sub_tipo_trans){
            if (vistaAjusStock.txt_cod_sub_tipo_trans.getText().equals("")) {
                ...
                tipo_transa = ModeloSubtiptrans.valida_sub_tipo_trans("ST",Integer.parseInt(vistaAjusStock.txt_cod_sub_tipo_trans.getText()));
                //System.out.println("Valor:"+tipo_transa);
                if (tipo_transa != null) {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getSource()== vistaAjusStock.tbl_art_un_lote){
                if (e.VK_ENTER==e.getKeyCode()){
                    agregar_lote_art();
                }
        }
    ...
    private void agregar_lote_art() {
        int cod = vistaAjusStock.tbl_art_un_lote.getSelectedRow();
                        if (cod==-1) {
                           JOptionPane.showMessageDialog(null, "Debe Seleccionar Una Fila Para Poder Realizar La Operacion  ", "Mensaje Del Sistema", JOptionPane.WARNING_MESSAGE);
                        } else {
                            this.vistaAjusStock.txt_cod_un_med.setText(vistaAjusStock.tbl_art_un_lote.getValueAt(cod, 1).toString());
                            this.vistaAjusStock.txt_nro_lote.setText(vistaAjusStock.tbl_art_un_lote.getValueAt(cod, 2).toString());
                            this.vistaAjusStock.cerrar_ventana_art_un_lot();
                            vistaAjusStock.txt_cod_prod_busq.requestFocus();
                        }
    }
    ...
    private void valida_codigo_articulo() {
        Integer res1 = modeloArticulo.retorna_cant_cod_aticulo_ajust(vistaAjusStock.txt_cod_prod_busq.getText());
        ...
        if (res1 == 1 /*|| ((res1 > 1 && ((vistaFactura_ven.txt_cod_un_med.getText() != null && vistaFactura_ven.txt_cod_un_med.getText().compareToIgnoreCase("") != 0) &&
            ...
            List<articulo> articuloList = modeloArticulo.dato_articulo_ajust(vistaAjusStock.txt_cod_prod_busq.getText());
            for (articulo rpc : articuloList) {
                vistaAjusStock.txt_desc_prod_busq.setText(rpc.getDesc_articulo());
                vistaAjusStock.txt_cod_un_med.setText(rpc.getCod_un_med());
                vistaAjusStock.txt_nro_lote.setText(rpc.getNro_lote());
                estado = true;
            }
            if (estado == true) {
                Integer precio_venta = modeloArticulo.retorna_precioun_art(vistaAjusStock.txt_cod_prod_busq.getText(), vistaAjusStock.txt_cod_un_med.getText(), vistaAjusStock.txt_nro_lote.getText());
                //if (vistaFactura_ven.txt_cantidad.getText() == null && vistaFactura_ven.txt_cantidad.getText().compareToIgnoreCase("") == 0) {
                if (vistaAjusStock.txt_cantidad.getText() == null || vistaAjusStock.txt_cantidad.getText().compareToIgnoreCase("") == 0) {    
        ...
        } else if (res1 > 1 && ((vistaAjusStock.txt_cod_un_med.getText() != null && vistaAjusStock.txt_cod_un_med.getText().compareToIgnoreCase("") != 0) &&
                                (vistaAjusStock.txt_nro_lote != null && vistaAjusStock.txt_nro_lote.getText().compareToIgnoreCase("") != 0))) {
            boolean estado = false;
            List<articulo> articuloList = modeloArticulo.dato_art_un_lot_ajust(vistaAjusStock.txt_cod_prod_busq.getText(), vistaAjusStock.txt_cod_un_med.getText(), vistaAjusStock.txt_nro_lote.getText());
            for (articulo rpc : articuloList) {
                vistaAjusStock.txt_desc_prod_busq.setText(rpc.getDesc_articulo());
                vistaAjusStock.txt_cod_un_med.setText(rpc.getCod_un_med());
                vistaAjusStock.txt_nro_lote.setText(rpc.getNro_lote());
            ...
            if (estado == true) {
               ...
               (vistaAjusStock.txt_nro_lote == null || vistaAjusStock.txt_nro_lote.getText().compareToIgnoreCase("") == 0)) {
            vistaAjusStock.ventana_art_un_lot();
            cargar_art_un_lote(vistaAjusStock.tbl_art_un_lote, vistaAjusStock.txt_cod_prod_busq.getText());
        } else {
    ...
    private void cargar_art_un_lote(JTable tbl_art_un_lote, String arti) {
        ...
        Object[] columna = new Object[3];
        List<articulo> articuloList = modeloArticulo.dato_articulo_ajust(arti);
        for (articulo rpc : articuloList) {
