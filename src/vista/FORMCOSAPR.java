 ...
 */
public class FORMCOSAPR extends javax.swing.JFrame {

    /**
     * Creates new form FORMCOSAPR
     */
    public FORMCOSAPR() {
        initComponents();
    ...
    private void cerrar_ventan_cons_saldo() {
        setDefaultCloseOperation(FORMCOSAPR.DO_NOTHING_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        btn_agreg_busq.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_agreg_busqActionPerformed(evt);
            }
        });
        jPanel7.add(btn_agreg_busq, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, -1, -1));

        ventana_busqueda.getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 300));

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("CONSULTA DE SALDO PROVEEDOR(FORMCOSAPR)");
        setResizable(false);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255)), "CONSULTA DE SALDO PROVEEDOR", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12), new java.awt.Color(0, 153, 255))); // NOI18N
        ...
        jScrollPane1.setViewportView(tbl_saldo_cliente);

        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 10, 840, 290));

        jLabel1.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 153, 204));
        jLabel1.setText("Cancelado");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 305, -1, -1));

        jLabel2.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 51, 51));
        jLabel2.setText("Pendiente");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 305, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 51, 0));
        jLabel4.setText("TOTAL:");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 310, -1, -1));

        txt_total.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jPanel3.add(txt_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 305, 150, 25));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 860, 330));
        ...
        jLabel7.setText("Fec Venc Desde");
        ...
        jLabel5.setText("Fec Venc Hasta");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 50, -1, -1));
        ...
        jPanel2.add(btn_busq_prov, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 20, 25, 25));
    ...
    private void btn_agreg_busqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agreg_busqActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_agreg_busqActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FORMCOSAPR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FORMCOSAPR().setVisible(true);
            }
        });
    }
