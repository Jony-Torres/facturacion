...
private void cerrar_ventan_person() {
   ...
   public void cerrar_ventanapersona(){
    ...
    private void initComponents() {
        ...
        rdb_gen_cliente = new javax.swing.JRadioButton();
        ...
        jLabel13.setText("Generar Cliente:");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 190, -1, -1));
        ...
        rdb_gen_cliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdb_gen_clienteActionPerformed(evt);
            }
        });
        jPanel2.add(rdb_gen_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 190, 50, 20));

        jLabel17.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel17.setText("Es Banco:");
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 160, -1, -1));
...
//        }
    ...
    private void rdb_gen_clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdb_gen_clienteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdb_gen_clienteActionPerformed
    ...
    public javax.swing.JRadioButton rdb_gen_cliente;
    ...
    private void bloquea_campos() {
     ...
     rdb_gen_cliente.setEnabled(false);
    ...
    public void habilita_campos() {
     ...
     rdb_gen_cliente.setEnabled(true);
     rdb_gen_cliente.setSelected(true);
